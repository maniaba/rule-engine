...
/**
 * Defines the ruleset used for the code style in the project.
 *
 * @internal Use of this class is not covered by the backward compatibility
 */
final class CodeStyle extends AbstractRuleset
{
    public function __construct()
    {
        $this->name = 'Code Style Ruleset';
