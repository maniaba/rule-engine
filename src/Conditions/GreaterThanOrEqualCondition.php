...
final class GreaterThanOrEqualCondition extends AbstractCondition
{
    ...
    {
        return "Field '{$this->contextName}' is not greater than or equal to the expected value '{$this->value}'.";
    }
