            ...
            if (array_key_exists($name, $arguments)) {
                ...
                if ($parameterType instanceof ReflectionUnionType) {
                    ...
                    foreach ($parameterType->getTypes() as $type) {
                        ...
                        $argumentType = $this->gettype($arguments[$name]);
                    ...
                    if (!in_array($parameterTypeName, [null, 'mixed'], true) && (!($parameterType?->allowsNull() && $arguments[$name] === null) && $parameterTypeName !== $argumentType)) {
