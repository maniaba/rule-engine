...
final class FieldSelectorTest extends TestCase
{
    ...
    {
        return [
            'prvi korisnik'  => ['users[0]', ['id' => 1, 'name' => 'Alice', 'age' => 25, 'active' => true]],
            'drugi korisnik' => ['users[1]', ['id' => 2, 'name' => 'Bob', 'age' => 30, 'active' => false]],
            'treci korisnik' => ['users[2]', ['id' => 3, 'name' => 'Charlie', 'age' => 35, 'active' => true]],

            'prvi log'  => ['logs[0]', ['id' => 1, 'level' => 'info', 'message' => 'Initialization successful.']],
            'drugi log' => ['logs[1]', ['id' => 2, 'level' => 'error', 'message' => 'Database connection failed.']],
        ];
    }
    ...
    {
        return [
            'korisnik s id=2'         => ['users[id:2]', ['id' => 2, 'name' => 'Bob', 'age' => 30, 'active' => false]],
            'korisnik s imenom Alice' => ['users[name:Alice]', ['id' => 1, 'name' => 'Alice', 'age' => 25, 'active' => true]],
            'log s level=error'       => ['logs[level:error]', ['id' => 2, 'level' => 'error', 'message' => 'Database connection failed.']],
        ];
    }
    ...
    {
        return [
            'prvi korisnik s age>=30' => ['users[age:>=30]', ['id' => 2, 'name' => 'Bob', 'age' => 30, 'active' => false]],
            'prvi korisnik s age>25'  => ['users[age:>25]', ['id' => 2, 'name' => 'Bob', 'age' => 30, 'active' => false]],
            'prvi korisnik s age<30'  => ['users[age:<30]', ['id' => 1, 'name' => 'Alice', 'age' => 25, 'active' => true]],
            'prvi korisnik s age<=35' => ['users[age:<=35]', ['id' => 1, 'name' => 'Alice', 'age' => 25, 'active' => true]],
        ];
    }
    ...
    {
        return [
            'prvi korisnik s active=true'  => ['users[active:true]', ['id' => 1, 'name' => 'Alice', 'age' => 25, 'active' => true]],
            'prvi korisnik s active=false' => ['users[active:false]', ['id' => 2, 'name' => 'Bob', 'age' => 30, 'active' => false]],
        ];
    }
    ...
    {
        return [
            'nepostojeći indeks'   => ['users[99]'],
            'nepostojeći ključ'    => ['users[id:9999]'],
            'neispravan filter'    => ['users[invalidFilter]'], // Nepoznat format
            'nepoznati operator'   => ['users[id:<>5]'], // Operator <> nije podržan
            'nepostojeći property' => ['nonexistent[key:value]'],
        ];
    }
