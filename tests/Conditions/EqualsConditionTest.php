...
final class EqualsConditionTest extends TestCase
{
    ...
    public function testConditionNotSatisfiedWhenFieldDoesNotEqualValue(): void
    {
        ...
        $this->assertSame("Field 'field' does not equal the expected value 'value'.", $condition->getFailureMessage());
    }
    ...
    public function testConditionNotSatisfiedWithStrictTypeMismatch(): void
    {
        ...
        $this->assertFalse($condition->isSatisfied($context));
        $this->assertSame("Field 'field' does not equal the expected value '123'.", $condition->getFailureMessage());
    }
    ...
    public function testConditionNotSatisfiedWithNullValueMismatch(): void
    {
        ...
        $this->assertFalse($condition->isSatisfied($context));
        $this->assertSame("Field 'field' does not equal the expected value ''.", $condition->getFailureMessage());
    }
    ...
    public function testConditionNotSatisfiedWithArrayMismatch(): void
    {
        ...
        $this->assertFalse($condition->isSatisfied($context));
        $this->assertSame("Field 'field' does not equal the expected value 'Array'.", $condition->getFailureMessage());
    }
}
